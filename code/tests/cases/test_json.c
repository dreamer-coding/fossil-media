...
FOSSIL_TEST(c_test_json_parse_null) {
...
FOSSIL_TEST(c_test_json_parse_bool) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_parse_number) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_parse_string) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_parse_array) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_parse_object) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_stringify_roundtrip) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_clone_and_equals) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_equals_not_equal) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_new_null) {
...
FOSSIL_TEST(c_test_json_new_bool) {
...
FOSSIL_TEST(c_test_json_new_number) {
...
FOSSIL_TEST(c_test_json_new_string) {
...
FOSSIL_TEST(c_test_json_new_array_and_append) {
...
FOSSIL_TEST(c_test_json_new_object_and_set_get_remove) {
...
FOSSIL_TEST(c_test_json_array_reserve) {
    fossil_media_json_value_t *arr = fossil_media_json_new_array();
    ASSUME_NOT_CNULL(arr);
...
FOSSIL_TEST(c_test_json_object_reserve) {
    fossil_media_json_value_t *obj = fossil_media_json_new_object();
    ASSUME_NOT_CNULL(obj);
...
FOSSIL_TEST(c_test_json_new_int_and_get_int) {
...
FOSSIL_TEST(c_test_json_validate) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_get_path) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_parse_empty_array) {
    fossil_media_json_error_t err = {0};
    const char *json = "[]";
    fossil_media_json_value_t *val = fossil_media_json_parse(json, &err);
    ASSUME_NOT_CNULL(val);
...
FOSSIL_TEST(c_test_json_parse_empty_object) {
    fossil_media_json_error_t err = {0};
    const char *json = "{}";
    fossil_media_json_value_t *val = fossil_media_json_parse(json, &err);
    ASSUME_NOT_CNULL(val);
...
FOSSIL_TEST(c_test_json_parse_invalid_trailing_comma_array) {
    fossil_media_json_error_t err = {0};
    const char *json = "[1,2,]";
    fossil_media_json_value_t *val = fossil_media_json_parse(json, &err);
...
FOSSIL_TEST(c_test_json_parse_invalid_trailing_comma_object) {
    fossil_media_json_error_t err = {0};
    const char *json = "{\"a\":1,}";
    fossil_media_json_value_t *val = fossil_media_json_parse(json, &err);
    ASSUME_ITS_CNULL(val);
...
FOSSIL_TEST(c_test_json_parse_unterminated_string) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_parse_large_number) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_stringify_escape_chars) {
...
FOSSIL_TEST(c_test_json_object_remove_nonexistent) {
    fossil_media_json_value_t *obj = fossil_media_json_new_object();
    ASSUME_NOT_CNULL(obj);
...
FOSSIL_TEST(c_test_json_array_get_out_of_bounds) {
    fossil_media_json_value_t *arr = fossil_media_json_new_array();
    ASSUME_NOT_CNULL(arr);
    fossil_media_json_array_append(arr, fossil_media_json_new_number(1));
...
FOSSIL_TEST(c_test_json_object_get_nonexistent) {
    fossil_media_json_value_t *obj = fossil_media_json_new_object();
    ASSUME_NOT_CNULL(obj);
    fossil_media_json_object_set(obj, "foo", fossil_media_json_new_string("bar"));
...
FOSSIL_TEST(c_test_json_parse_multiple_values) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_parse_deeply_nested) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_parse_mixed_types_array) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST(c_test_json_parse_object_with_array_values) {
    fossil_media_json_error_t err = {0};
...
FOSSIL_TEST_GROUP(c_json_tests) {
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_null);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_bool);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_number);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_string);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_array);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_object);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_stringify_roundtrip);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_clone_and_equals);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_equals_not_equal);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_new_null);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_new_bool);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_new_number);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_new_string);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_new_array_and_append);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_new_object_and_set_get_remove);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_array_reserve);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_object_reserve);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_new_int_and_get_int);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_validate);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_get_path);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_empty_array);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_empty_object);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_invalid_trailing_comma_array);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_invalid_trailing_comma_object);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_unterminated_string);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_large_number);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_stringify_escape_chars);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_object_remove_nonexistent);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_array_get_out_of_bounds);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_object_get_nonexistent);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_multiple_values);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_null_input);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_stringify_null_value);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_clone_null);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_equals_nulls);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_nested_object_array);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_deeply_nested);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_mixed_types_array);
    FOSSIL_ADD_TEST(c_json_fixture, c_test_json_parse_object_with_array_values);

    FOSSIL_ADD_SUITE(c_json_fixture);
} // end of tests
